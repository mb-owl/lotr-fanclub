...
const ContactForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {status === "success" && <p className="text-green-500">✔️ Message sent! We'll reply soon, precious.</p>}
            {status === "error" && <p className="text-red-500">❗ Agh! Your message was intercepted by orcs...try again?</p>}
            </form>
    );
};
